...
""")
    ...
    def test_build_file_tree(self, temp_project, temp_config):
        ...
        assert os.path.join('src', 'app.py').replace('\\', '/') in [k.replace('\\', '/') for k in file_tree.keys()] or 'src\\app.py' in file_tree or 'src/app.py' in file_tree
