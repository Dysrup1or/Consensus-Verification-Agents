...
"""
    ...
    def test_validate_invariants_wrong_id_type(self):
        ...
        invariants = {"technical": [{"id": "not int", "desc": "Wrong type"}], "functional": []}
...
Additional notes..."""
    ...
    def test_save_criteria(self, temp_config):
        ...
        try:
            ...
            invariants = {"technical": [{"id": 1, "desc": "test"}], "functional": [{"id": 1, "desc": "test2"}]}
    ...
    def mock_litellm(self):
        ...
        with patch("modules.parser.litellm") as mock:
            ...
            mock_response.choices[0].message.content = json.dumps(
                {
                    "technical": [{"id": 1, "desc": "Use Python 3.10+"}, {"id": 2, "desc": "Use Flask framework"}],
                    "functional": [{"id": 1, "desc": "User authentication"}, {"id": 2, "desc": "CRUD operations"}],
                }
            )
